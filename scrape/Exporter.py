...
def main(argv):
 ...
 python Exporter.py --username "barackobama" --maxtweets 10 --toptweets\n""")
	...
	try:
		...
		writer.writerow(['time','text','geo','hashtags'])
		print ('Searching...')
		...
		def receiveBuffer(tweets):
			for t in tweets:
				...
				# writer.writerow([t.wordnouns, t.geo, t.polarity, t.subjectivity, t.time, t.hashtags])
			outputFile.flush()
			print ('More {} saved on file...'.format(len(tweets)))
